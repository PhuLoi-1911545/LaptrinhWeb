            ...
            <div class="container-fluid py-3">
                <div class="row main-content m-auto add-food__content">
                    <div class="col-md-4 company__info d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4 class="company_title">Food</h4>
                    </div>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['image']['name'])) { // Check image selected or not
            ...
            if ($image_name != "") {
                ...
                if ($upload == FALSE) { // image upload failed
                    ...
                    header("location:".SITEURL."manager_page/food/add_food.php");
                    die();
                }
            }
        } else {
        ...
        // 3. Check Food inserted or not
        if ($res == TRUE) {
            $_SESSION['add'] = "<h6 class='text-success text-center'> Food added successfully! </h6>"; //display message
            echo("<script>location.href = '".SITEURL."manager_page/food/food.php';</script>");
        } else {
            $_SESSION['add'] = "<h6 class='text-danger text-center'> Food added failed! </h6>"; //display message
            echo("<script>location.href = '".SITEURL."manager_page/food/add_food.php';</script>");
        }
    }
?>