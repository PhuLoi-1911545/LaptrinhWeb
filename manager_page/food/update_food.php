                            ...
                            <?php
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    if ($count2 == 1) {
                                        ...
                                        $_SESSION['not_food'] = "<h6 class='text-danger text-center'> Food NOT Found! </h6>";
...
<?php
    if (isset($_POST['submit'])) {
        ...
        // 4. Check food updated or not
        if ($res3 == TRUE) {
            $_SESSION['update'] = "<h6 class='text-success text-center'> Food updated successfully! </h6>"; //display message
            echo("<script>location.href = '".SITEURL."manager_page/food/food.php';</script>");
        } else {
            $_SESSION['update'] = "<h6 class='text-danger text-center'> Food updated failed! </h6>"; //display message
            echo("<script>location.href = '".SITEURL."manager_page/food/food.php';</script>");
        }
    }
?>